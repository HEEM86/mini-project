        ...
        <div className=“col-md-10 mx-auto text-center”>
            <div className=“row”>
                <form className=“col-md-6 mx-auto”>
                    ...
                    <Input value={this.state.currentTerm}
                                ...
                                <ListItem key={i}>
                                    <div className=“card” >
                                        <div className=“card-body”>
                                            <img src={book.volumeInfo.imageLinks ? book.volumeInfo.imageLinks.thumbnail : “https://cdn4.iconfinder.com/data/icons/basic-17/80/22_BO_open_book-512.png”}
